...
def handler(ctx, data: io.BytesIO = None):
    ...
    try:
        ...
        bucket_response = object_storage.get_object(
            namespace_name=namespace, bucket_name="hackathon-model-bucket", object_name="demo/test_object.json")
    ...
    message = f"Message modified locally and deployed with oci cli. {firstNumber} plus {secondNumber} multiplied by the constant: {constant} is equal to = {(firstNumber + secondNumber) * constant}"
