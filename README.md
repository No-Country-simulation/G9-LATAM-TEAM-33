...
│
├── 📁 .github/workflows
│   ├──upload-to-OCI-demonstration.yml
│   ├──upload-to-OCI-staging.yml
│
├── 📁 assets/
│
├── 📁 backend/
...
|------------|-----|-------------------|
| Jhon Fernando Gomez Villa  | Backend | Desarrollo de la API |
| Angie Alejandra Vega  | Backend | Desarrollo de la API |
| Jhon Rodríguez | Ciencia de Datos | Modelado y entrenamiento |
| Tomas Raggio | Ciencia de Datos | Modelado y entrenamiento |
| Angela Balta | Ciencia de Datos | Modelado y entrenamiento |
| Isaac Ruiz | Ciencia de Datos | Modelado y entrenamiento |
| Josue Marquez | Cloud | Integración con OCI |
| Matias Marquez | Documentación | README y presentación |
